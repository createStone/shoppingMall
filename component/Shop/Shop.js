    ...
    renderNabBar(){
        return (
            <View style={styles.navBarStyle}>
                <TouchableOpacity activeOpacity={0.5} onPress={()=>{alert('定位')}}>
                     <Image source={{uri:'icon_shop_local'}} style={styles.imageStyle}></Image>
                </TouchableOpacity>
                <Text style={styles.title}>商家</Text>
                <TouchableOpacity activeOpacity={0.5} onPress={()=>{alert('搜索')}}>
                     <Image source={{uri:'icon_shop_search'}} style={styles.imageStyle}></Image>
                </TouchableOpacity>
